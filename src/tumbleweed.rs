...
use crate::hexboard::{
    get_offsets, get_round_idx, BoardCoord, Direction, DirectionIterator, RoundHexBoard,
};
...
fn update_los(
    ...
    los[coord].reset_valid(Player::Black);
    los[coord].reset_valid(Player::White);
